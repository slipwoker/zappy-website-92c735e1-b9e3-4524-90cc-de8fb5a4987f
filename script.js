  ...
  if (contactForm) {
    ...
    contactForm.addEventListener('submit', function (e) {
      ...
      if (!isValid) {
        ...
        let formErrorMsg = contactForm.querySelector('.form-submit-error');
        if (!formErrorMsg) {
          formErrorMsg = document.createElement('div');
          formErrorMsg.className = 'form-submit-error';
          formErrorMsg.setAttribute('role', 'alert');
          contactForm.insertBefore(formErrorMsg, contactForm.firstChild);
        }
        formErrorMsg.textContent = contactForm.dataset.errorGeneral || 'Please correct the errors above and try again.';
        formErrorMsg.style.display = 'block';
      } else {
        const formErrorMsg = contactForm.querySelector('.form-submit-error');
        if (formErrorMsg) {
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '92c735e1-b9e3-4524-90cc-de8fb5a4987f',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '92c735e1-b9e3-4524-90cc-de8fb5a4987f';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '92c735e1-b9e3-4524-90cc-de8fb5a4987f';
